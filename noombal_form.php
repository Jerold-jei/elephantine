...
try {
    ...
    $mail->Subject = 'Noombal Project Form';
    ...
    $sql = "INSERT INTO  `noombal_form`(`name`, `phone`, `email`, `message`) VALUES ('$name','$phone','$email','$comment')";

    if ((mysqli_query($conn, $sql))&&($mail->send())) {
        echo "<script> 
        alert('Form is submitted successfully');
        window.location.href = 'noombal-project.php';
        </script>";
    } else {
