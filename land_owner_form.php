...
try {
    ...
    $message .= "<tbody>
          ...
          <tr align='left' height='50'>
          <th style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>Site Address</th>
          <td style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>".$site_address."</td>         
          </tr>    

          <tr align='left' height='50'>
          <th style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>Site Area in sq.ft</th>
          <td style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>".$site_size." sq.ft</td>         
          </tr>

          <tr align='left' height='50'>
          <th style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>Estimated Price per sq.ft</th>
          <td style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>Rs. ".$estimated_price."</td>         
          </tr>
    ...
    $sql = "INSERT INTO land_owner_form(name, email, phone, site_address, site_area, estimation, message) VALUES ('$name','$email','$phone','$site_address','$site_size','$estimated_price','$comment')";

    if ((mysqli_query($conn, $sql))&&($mail->send())) {
        echo "<script> 
        alert('Form is submitted successfully');
        window.location.href = 'land-owners.php';
        </script>";
    } else {
