...
try {
    ...
    $mail->Subject = 'Bliss Project Form';
    ...
    $message .= "<thead>
      ...
      <img src='https://elephantine.co/elephantine-new/img/elephantine-logo.png' alt='logo' title='logo' style='height:auto; width:50%; max-width:50%;' />      
      </th> 
      </tr>
                </thead>";
    $message .= "<tbody>
    ...
    $sql = "INSERT INTO  `bliss_form`(`name`, `phone`, `email`, `message`) VALUES ('$name','$phone','$email','$comment')";

    if ((mysqli_query($conn, $sql))&&($mail->send())) {
        echo "<script> 
        alert('Form is submitted successfully');
        window.location.href = 'bliss-project.php';
        </script>";
    } else {
