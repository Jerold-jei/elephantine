...
try {
    ...
    $message .= "<tbody>
          ...
          <tr align='left' height='50'>
          <th style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>Referal Name</th>
          <td style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>".$ref_name."</td>         
          </tr>
       
          <tr align='left' height='50'>
          <th style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>Referal Phone Number</th>
          <td style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>".$ref_phone."</td>         
          </tr>    

          <tr align='left' height='50'>
          <th style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>Referal Email</th>
          <td style='font-size:15px; border: 1px groove; padding-left: 15px; font-family: Roboto-Regular;'>".$ref_email."</td>         
          </tr>
          </tbody>";
    $message .= "</table>";
    $message .= "</body></html>";   
    ...
    $sql = "INSERT INTO `refer_form`(`name`, `phone`, `ref_name`, `ref_phone`, `ref_email`) VALUES ('$name','$phone','$ref_name','$ref_phone','$ref_email')";
