...
try {
    ...
    $mail->Subject = 'Thematic Projects Form';
    ...
    $sql = "INSERT INTO `thematic_form`(`name`, `email`, `phone`, `subject`, `message`) VALUES ('$name','$email','$phone','$subject','$comment')";

    if ((mysqli_query($conn, $sql))&&($mail->send())) {
        echo "<script> 
        alert('Form is submitted successfully');
        window.location.href = 'thematic-projects.php';
        </script>";
    } else {
