...
try {
    ...
    $mail->Subject = 'Holiday Homes Form';
    ...
    $sql = "INSERT INTO `holiday_homes_form`(`name`, `email`, `phone`, `subject`, `message`) VALUES ('$name','$email','$phone','$subject','$comment')";

    if ((mysqli_query($conn, $sql))&&($mail->send())) {
        echo "<script> 
        alert('Form is submitted successfully');
        window.location.href = 'holiday-homes.php';
        </script>";
    } else {
