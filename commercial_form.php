...
try {
    ...
    $mail->Subject = 'Commercial Buildings Form';
    ...
    $sql = "INSERT INTO `commercial_form`(`name`, `email`, `phone`, `subject`, `message`) VALUES ('$name','$email','$phone','$subject','$comment')";

    if ((mysqli_query($conn, $sql))&&($mail->send())) {
        echo "<script> 
        alert('Form is submitted successfully');
        window.location.href = 'commercial-buildings.php';
        </script>";
    } else {
