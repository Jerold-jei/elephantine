            ...
            <div class="row form-div-row">
                <div class="col-md-12">
                    <div class="form-div-content parallax-move" data-parallax-content='{"shift": 40, "duration": 3}'>
                        <h1 class="spartanBold" data-aos="fade-right"> Blog </h1>                       
                    </div>
                </div>               
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="blog-inner.php">
                    <picture> 
                        <source data-srcset="img/new/plus.svg" media="(max-width: 1024px)" srcset="img/new/plus.svg"> 
                        <img data-src="img/new/plus.svg" src="img/new/plus.svg" alt="Elora Hardy portrait photo." class="lazyloaded parallax-move" data-parallax-content='{"shift": 20, "duration": 1}'>
                    </picture>
                </a>
                <span class="blog-date">REAL ESTATE TRENDS IN 2023</span>
                </div>
                <p class="elephantine_paragraph">The real estate industry is constantly evolving, and as we move into 2023, there are several exciting trends that we can expect to see.</p>
                <div class="blog-img">                  
                        <img data-src="img/blog/image_1.jpg" src="img/blog/image_1.jpg" alt="Elora Hardy portrait photo." class="lazyloaded parallax-move" data-parallax-content='{"shift": 20, "duration": 1}'>                  
                </div>
            ...
            <div class="col-md-6">
                <!--<div class="blog-content">-->
                <!--<div class="plus-btn">-->
                <!--<a href="blog-inner2.php">                   -->
                <!--        <img data-src="img/new/plus.svg" src="img/new/plus.svg" alt="Elora Hardy portrait photo." class="lazyloaded parallax-move" data-parallax-content='{"shift": 20, "duration": 1}'>-->
                <!--</a>-->
                <!--<span class="blog-date">August 22, 2022</span>-->
                <!--</div>-->
                <!--<p class="elephantine_paragraph">Excepteur sint occaecat cupidatat non proident, sunt in culpa -->
                <!--    qui officia deserunt mollit anim id est laborum."</p>-->

                <!--<div class="blog-img">                   -->
                <!--        <img data-src="img/blog/image_2.jpg" src="img/blog/image_2.jpg" alt="Elora Hardy portrait photo." class="lazyloaded parallax-move" data-parallax-content='{"shift": 20, "duration": 1}'>-->
                <!--</div>-->
                <!--</div>-->
            </div>          
