...
try {
    ...
    $mail->Subject = 'Logistics And Warehousing Form';
    ...
    $message .= "<tbody>
          ...
          <th colspan='4' style='background-color:#4b4c4d; font-family: Roboto-Regular; color:#fff; font-size:20px; border: 5px groove;'>      
            Logistics And Warehousing Form      
            </th>      
    ...
    $sql = "INSERT INTO `logistics_form`(`name`, `email`, `phone`, `subject`, `message`) VALUES ('$name','$email','$phone','$subject','$comment')";

    if ((mysqli_query($conn, $sql))&&($mail->send())) {
        echo "<script> 
        alert('Form is submitted successfully');
        window.location.href = 'logistics_warehousing.php';
        </script>";
    } else {
