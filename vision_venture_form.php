...
try {
    ...
    $mail->Subject = 'Vision Venture Form';
    ...
    $sql = "INSERT INTO `vision_venture_form`(`name`, `email`, `phone`, `subject`, `message`) VALUES ('$name','$email','$phone','$subject','$comment')";

    if ((mysqli_query($conn, $sql))&&($mail->send())) {
        echo "<script> 
        alert('Form is submitted successfully');
        window.location.href = 'our_vision_venture.php';
        </script>";
    } else {
